...
## Logo direction (brief for future asset)

- An octopus mark that reads at 16px (favicon) and as a wordmark. Geometric, confident, single-weight; the teal signal used sparingly. No literal gradient blobs. Deliverable tracked in [`docs/70-diagrams/`](../70-diagrams/) / a future `packages/ui` asset — not built in this docs pass.
