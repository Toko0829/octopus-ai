...
| --- | ---------------------------- | :-: | :-: | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Intake & goal framing        | ✅  |  —  | —                            | **Built** (`POST /intake`). Turns the one-liner into ICP, offer, target metric, budget band, timeline. Asks nothing when the goal is already specific; otherwise one card of at most four questions, answered on the card one at a time, at most twice. |
