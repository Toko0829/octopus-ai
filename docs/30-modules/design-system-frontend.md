...
> - **What will not happen is stated as plainly as what will.** Somebody entering a budget reasonably wonders whether money starts moving on approve. It does not: the campaign is recorded at `ready` and stops, and the card and the system notice both say so. The approved banner repeats the figure and the currency for the same reason.
